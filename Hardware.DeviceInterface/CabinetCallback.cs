...
namespace Hardware.DeviceInterface
{
    public class CabinetCallback
    {
        ...
        //public delegate void OnToolTakenDelegate(string rfid, int subCabinetNo);
        ...
        /// </summary>
        /// <param name="toolNo"></param>       
        //public delegate void OnToolReturnDelegate(int subCabinetNo, List<string> oldTagList, List<string> newTagList);
