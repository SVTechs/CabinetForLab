...
namespace Hardware.DeviceInterface
{
    ...
    {
        private static SerialPortStream _serialCtrl;
        ...
        public static int Init(int serialPort, int iBaudRate, int iParity, int iDataBits, int iStopBits)
        {
            try
            {
                _serialCtrl = new SerialPortStream("COM" + serialPort);
                ...
                {
                    case 0:
                        //_serialCtrl.StopBits = StopBits.0;
                        break;
                    case 1:
                        _serialCtrl.StopBits = StopBits.One;
                        break;
                    case 2:
                        _serialCtrl.StopBits = StopBits.One5;
                        break;
                    case 3:
        ...
        public static void GenerateTestData(int position, float dataBase)
        {
            ...
            TorqueDevice.TorqueInfo uInfo = new TorqueDevice.TorqueInfo("0", "SP20A15056", true, true, dataBase + (float)rd.Next(1, 10) / 100 , 20);
