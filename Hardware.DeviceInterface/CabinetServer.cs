...
namespace Hardware.DeviceInterface
{
    ...
    {
        private static int _serverPort, _canPort;
        ...
        public static void Init(string serverIP, int serverPort, string canIP, int canPort)
        {
        ...
        {
            if (session.RemoteEndPoint.Address.ToString() == _canIP && session.RemoteEndPoint.Port == _canPort) canSession = session;
