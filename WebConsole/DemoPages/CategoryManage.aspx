<%@ Page Title="" Language="C#" MasterPageFile="~/Master/Main.Master" AutoEventWireup="true" CodeBehind="CategoryManage.aspx.cs" Inherits="WebConsole.DemoPages.CategoryManage" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentHolder" runat="server">
            ...
            <f:Grid ID="MainGrid" runat="server" ShowBorder="true" ShowHeader="false" EnableCheckBoxSelect="false"
                ...
                <Toolbars>
                    <f:Toolbar ID="MainToolbar" Position="Top" runat="server">
                        <Items>
                            <f:Button ID="btnInertNew" runat="server" Icon="Add" EnablePostBack="false" OnClientClick="showInsertWindow();" Text="新增分类" />
                        </Items>
                    </f:Toolbar>
                </Toolbars>
                ...
                <Columns>
                    ...
                    <f:BoundField DataField="NodeName" HeaderText="分类名称" DataSimulateTreeLevelField="TreeLevel" BoxFlex="1" />
                    <f:BoundField DataField="NodeOrder" HeaderText="分类排序" BoxFlex="1" TextAlign="Center" />
                    <f:BoundField DataField="NodeDesp" HeaderText="备注" BoxFlex="1" TextAlign="Center" />
    ...
    <f:Window ID="EditWindow" Width="650px" Height="350px" Icon="TagBlue" Title="编辑分类" Hidden="True"
        ...
        <Items>
            <f:SimpleForm ID="EditForm" ShowBorder="false" ShowHeader="false" runat="server"
                ...
                <Items>
                    <f:TextBox ID="tbNodeId" runat="server" Label="Id" Hidden="true" />
                    <f:TextBox ID="tbNodeName" runat="server" Label="分类名称" Required="true" ShowRedStar="true" />
                    <f:NumberBox ID="tbNodeOrder" Label="分类排序" Required="true" ShowRedStar="true" runat="server" />
                    <f:TextArea ID="tbNodeDesp" runat="server" Label="备注" />
                </Items>
            </f:SimpleForm>
        </Items>
    </f:Window>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ScriptHolder" runat="server">
    ...
    <script src="../Res/js/demopages/CategoryManage.js"></script>
