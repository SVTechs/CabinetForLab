<%@ Page Title="" Language="C#" MasterPageFile="~/Master/Main.Master" AutoEventWireup="true" CodeBehind="DutyUser.aspx.cs" Inherits="WebConsole.Framework.DutyUser" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentHolder" runat="server">
    ...
    <f:RegionPanel ID="MainPanel" ShowBorder="false" runat="server">
        <Regions>
            <f:Region ID="RegionDuty" ShowBorder="false" ShowHeader="false" Width="250px" Position="Left"
                Layout="Fit" BodyPadding="5px" runat="server">
                <Items>
                    <f:Grid ID="GridDuty" runat="server" ShowBorder="true" ShowHeader="false" EnableCheckBoxSelect="false"
                        ...
                        <Columns>
                            ...
                            <f:BoundField DataField="DutyName" HeaderText="职务名称" DataSimulateTreeLevelField="TreeLevel" BoxFlex="1" />
                        </Columns>
                    </f:Grid>
                </Items>
            </f:Region>
                ...
                <Items>
                    <f:Grid ID="GridUser" runat="server" BoxFlex="1" ShowBorder="true" ShowHeader="false"
                        ...
                        <Columns>
                            ...
                            <f:LinkButtonField TextAlign="Center" Icon="Delete" ToolTip="从当前职务中移除此用户"
                                ConfirmText="确定从当前职务中移除此用户？" ConfirmTarget="Top" CommandName="Delete" Width="50px">
                            </f:LinkButtonField>
                        </Columns>
                    </f:Grid>
                </Items>
