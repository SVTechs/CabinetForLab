<%@ Page Title="" Language="C#" MasterPageFile="~/Master/Main.Master" AutoEventWireup="true" CodeBehind="RoleUser.aspx.cs" Inherits="WebConsole.Framework.RoleUser" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentHolder" runat="server">
    ...
    <f:RegionPanel ID="MainPanel" ShowBorder="false" runat="server">
        <Regions>
            <f:Region ID="RegionRole" ShowBorder="false" ShowHeader="false" Width="250px" Position="Left"
                Layout="Fit" BodyPadding="5px" runat="server">
                <Items>
                    <f:Grid ID="GridRole" runat="server" ShowBorder="true" ShowHeader="false" EnableCheckBoxSelect="false"
                ...
                <Items>
                    <f:Grid ID="GridUser" runat="server" BoxFlex="1" ShowBorder="true" ShowHeader="false"
                        ...
                        <Columns>
                            ...
                            <f:LinkButtonField TextAlign="Center" Icon="Delete" ToolTip="从当前角色中移除此用户"
