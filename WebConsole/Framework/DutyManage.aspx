<%@ Page Title="" Language="C#" MasterPageFile="~/Master/Main.Master" AutoEventWireup="true" CodeBehind="DutyManage.aspx.cs" Inherits="WebConsole.Framework.DutyManage" %>
            ...
            <f:Grid ID="MainGrid" runat="server" ShowBorder="true" ShowHeader="false" EnableCheckBoxSelect="false"
                ...
                <Toolbars>
                    <f:Toolbar ID="MainToolbar" Position="Top" runat="server">
                        <Items>                      
                            <f:Button ID="btnInertNew" runat="server" Icon="Add" EnablePostBack="false" OnClientClick="showInsertWindow();" Text="新增职务" />              
                        </Items>
                    </f:Toolbar>
                </Toolbars>
                ...
                <Columns>
                    ...
                    <f:BoundField DataField="DutyName" HeaderText="职务名称" DataSimulateTreeLevelField="TreeLevel" BoxFlex="2" />
                    <f:BoundField DataField="DutyOrder" HeaderText="排序" BoxFlex="1" TextAlign="Center" Hidden="true" />
        ...
        <Toolbars>
            ...
            <Items>
                <f:SimpleForm ID="EditForm" ShowBorder="false" ShowHeader="false" runat="server"
                    ...
                    <Items>
                        <f:TextBox ID="tbDutyId" runat="server" Label="Id" Hidden="true" />
                        <f:TextBox ID="tbDutyName" runat="server" Label="职务名称" Required="true" ShowRedStar="true" />
                        <f:NumberBox ID="tbDutyOrder" Label="职务排序" Required="true" ShowRedStar="true" runat="server" />
                        ...
                        <f:TextArea ID="tbDutyDesp" runat="server" Label="备注" />                       
                    </Items>
                </f:SimpleForm>
            </Items>
    </f:Window>
