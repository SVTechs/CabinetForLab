...
{
    public partial class FormSystem : UIForm
    {
        public static FormSystem formSystem;

        public static FormSystem Instance()
        {
            if (formSystem == null || formSystem.IsDisposed) formSystem = new FormSystem();
            return formSystem;
        }
        ...
        private void uiButtonRoleEdit_Click(object sender, EventArgs e)
        {
            ...
            FormRoleEdit formRoleEdit = FormRoleEdit.Instance("编辑角色");
            formRoleEdit.LoadData(tn.Tag.ToString().Split('|')[0], "");
            formRoleEdit.ShowDialog();
            LoadRoleTree();
        }
        ...
        {
            FormToolTypeEdit formToolTypeEdit = FormToolTypeEdit.Instance("新建类型");
        ...
        private void uiButtonToolTypeEdit_Click(object sender, EventArgs e)
        {
            ...
            FormToolTypeEdit formToolTypeEdit = FormToolTypeEdit.Instance("编辑类型");
