...
{
    public partial class FormUserRoleManageOld : UIForm
    {

        private static FormUserRoleManageOld formUserRoleManage;
        private static string userId;

        public FormUserRoleManageOld()
        {
            InitializeComponent();
        }

        public static FormUserRoleManageOld Instance(string id)
        {
            if (formUserRoleManage == null || formUserRoleManage.IsDisposed) formUserRoleManage = new FormUserRoleManageOld();
            userId = id;
