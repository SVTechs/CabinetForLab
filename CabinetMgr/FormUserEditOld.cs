...
{
    public partial class FormUserEditOld : UIForm
    {
        public static FormUserEditOld formUserEdit;
        ...
        public static FormUserEditOld Instance(string userName = "")
        {
            if (formUserEdit == null || formUserEdit.IsDisposed) formUserEdit = new FormUserEditOld();
            user = BllUserInfo.GetUserInfoByUserName(userName, out _);
            return formUserEdit;
        }

        public FormUserEditOld()
        {
            InitializeComponent();
        }
        ...
        private void uiButtonCapFinger_Click(object sender, EventArgs e)
        {
            ...
            FormFingerCapOld formFingerCap = FormFingerCapOld.Instance((int)user.TemplateId);
