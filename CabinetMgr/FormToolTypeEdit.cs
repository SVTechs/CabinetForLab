...
{
    public partial class FormToolTypeEdit : UIForm
    {
        public static FormToolTypeEdit formToolTypeEdit;
        public static long toolTypeId;

        public static FormToolTypeEdit Instance(string formTitle = "新建类型")
        {
            if (formToolTypeEdit == null || formToolTypeEdit.IsDisposed) formToolTypeEdit = new FormToolTypeEdit();
            formToolTypeEdit.Text = formTitle;
            return formToolTypeEdit;
        }

        public FormToolTypeEdit()
        {
            InitializeComponent();
        }
