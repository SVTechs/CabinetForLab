...
{
    public partial class FormLatticePermissionManageOld : UIForm
    {
        private static FormLatticePermissionManageOld formLatticePermissionManage;
        private static string ownerId, ownerType;

        public FormLatticePermissionManageOld()
        {
            InitializeComponent();
        }

        public static FormLatticePermissionManageOld Instance(string id, string idType)
        {
            if (formLatticePermissionManage == null || formLatticePermissionManage.IsDisposed) formLatticePermissionManage = new FormLatticePermissionManageOld();
            ownerId = id;
            ownerType = idType;
