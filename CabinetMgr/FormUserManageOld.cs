...
{
    public partial class FormUserManageOld : UIForm
    {
        public FormUserManageOld()
        {
            InitializeComponent();
        }
        ...
        private void uiButtonAdd_Click(object sender, EventArgs e)
        {
            ...
            FormUserEditOld formUserEdit = FormUserEditOld.Instance();
        ...
        private void uiButtonEdit_Click(object sender, EventArgs e)
        {
            ...
            FormUserEditOld formUserEdit = FormUserEditOld.Instance(ui.UserName);
            formUserEdit.ShowDialog();
            LoadUser();
        }
        ...
        private void uiButtonRole_Click(object sender, EventArgs e)
        {
            ...
            var selectRow = uiDataGridViewUser.SelectedRows[0];
            UserInfo ui = selectRow.DataBoundItem as UserInfo;
            FormUserRoleManageOld formUserRoleManage = FormUserRoleManageOld.Instance(ui.ID);
        ...
        private void uiButtonLattice_Click(object sender, EventArgs e)
        {
            ...
            var selectRow = uiDataGridViewUser.SelectedRows[0];
            UserInfo ui = selectRow.DataBoundItem as UserInfo;
            FormLatticePermissionManageOld formLatticePermissionManage = FormLatticePermissionManageOld.Instance(ui.ID, "User");
