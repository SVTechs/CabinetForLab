...
{
    public partial class FormToolEditOld : UIForm
    {

        public static FormToolEditOld formToolEdit;

        public FormToolEditOld()
        {
            InitializeComponent();
        }

        public static FormToolEditOld Instance(string formTitle = "新建工具")
        {
            if (formToolEdit == null || formToolEdit.IsDisposed) formToolEdit = new FormToolEditOld();
