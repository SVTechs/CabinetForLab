...
namespace Utilities.DbHelper
{
    public class AccessHelper
    {
        ...
        public static OleDbConnection GetConn(string connectionString)
        {
        ...
        /// </summary>
        public static DataSet GetDataSet(OleDbConnection conn, CommandType cmdType, string cmdText, params OleDbParameter[] cmdParms)
        {
            OleDbCommand cmd = new OleDbCommand();
            PrepareCommand(cmd, conn, null, cmdType, cmdText, cmdParms);
            OleDbDataAdapter adapter = new OleDbDataAdapter();
